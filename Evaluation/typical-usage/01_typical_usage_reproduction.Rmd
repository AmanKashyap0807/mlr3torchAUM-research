...
Installing required packages for mlr3torchAUM functionality.
...
# Install mlr3 ecosystem
if (!requireNamespace("mlr3", quietly = TRUE)) install.packages("mlr3")
if (!requireNamespace("mlr3torch", quietly = TRUE)) install.packages("mlr3torch")
if (!requireNamespace("data.table", quietly = TRUE)) install.packages("data.table")
if (!requireNamespace("ggplot2", quietly = TRUE)) install.packages("ggplot2")
```

## 1.2 Installing mlr3torchAUM
...
cat("mlr3torchAUM version:", as.character(packageVersion("mlr3torchAUM")), "\n")
